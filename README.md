...
- `TidyData.txt` is a written out text file from `run_analysis.R`, which is the mean features of each subject and each activity. Please refer to `CodeBook.md.` for more explicit information.
